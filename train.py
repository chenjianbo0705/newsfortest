...
tf.flags.DEFINE_string("positive_data_file", "./data/keji.xlsx", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/NBA.xlsx", "Data source for the negative data.")
...
x = np.array(word2vec_helpers.embedding_sentences(sentences, embedding_size = FLAGS.embedding_dim, file_to_save = os.path.join(out_dir, 'trained_word2vec.model')),dtype='float32')
